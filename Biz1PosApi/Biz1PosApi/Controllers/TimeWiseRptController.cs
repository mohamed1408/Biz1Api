...
namespace Biz1PosApi.Controllers
{
    ...
    public class TimeWiseRptController : Controller
    {
        ...
        [HttpGet("GetReportProducts")]
        public IActionResult GetReportProducts(DateTime frmdate, DateTime todate, TimeSpan fromTime, TimeSpan toTime, int storeId, int sourceId, int saleproductgroupid, int companyid, int productId, int categoryId)
        {
            try
            {
                //SqlConnection sqlCon = new SqlConnection("server=(LocalDb)\\MSSQLLocalDB; database=Biz1POS;Trusted_Connection=True;");
