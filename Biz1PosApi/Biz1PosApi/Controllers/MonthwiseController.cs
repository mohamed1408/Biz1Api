...
namespace Biz1PosApi.Controllers
{
    ...
    public class MonthwiseController : Controller
    {
        private POSDbContext db;
        public IConfiguration Configuration { get; }
        public MonthwiseController(POSDbContext contextOptions, IConfiguration configuration)
        {
            db = contextOptions;
        ...
        [HttpGet("GetRpt")]
        public IActionResult GetRpt(DateTime frmdate, DateTime todate, int companyId,  int storeId, int sourceId, string groupBy, int categoryId,int productId)
       {
            try
            {
                ...
                sqlCon.Open();
                SqlCommand cmd = new SqlCommand("dbo.MonthWiseProdSales", sqlCon);
